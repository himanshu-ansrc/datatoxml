...
class Multiplechoise extends PureComponent{
        ...
        handleChange = e => {
          this.props.jsondata.answer['txt'][e.target.name] = e.target.value
          ...
          render(){
             ...
             return (
                <Fragment>
                      ...
                      <div>
                       <FormControl className={classes.answerTrueFalse}>
                           ...
                           <Select
                             ...
                             name="answer"
                           >
                           <MenuItem value='true' value='true'>True</MenuItem>
                           <MenuItem value='false' value='false'>False</MenuItem>
                           </Select>
                       </FormControl>
